...
Source0  : https://files.pythonhosted.org/packages/b2/14/97b9137a02f57d2287f3a9731b3a339fda716d2d3a157d7d1d89c2bebf7b/flask-3.0.1.tar.gz
...
%prep
%setup -q -n flask-3.0.1
cd %{_builddir}/flask-3.0.1
pushd ..
cp -a flask-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705701906
