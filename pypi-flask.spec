...
Source0  : https://files.pythonhosted.org/packages/d8/09/c1a7354d3925a3c6c8cfdebf4245bae67d633ffda1ba415add06ffc839c5/flask-3.0.0.tar.gz
...
%prep
%setup -q -n flask-3.0.0
cd %{_builddir}/flask-3.0.0
pushd ..
cp -a flask-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696259842
