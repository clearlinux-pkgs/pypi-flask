...
Source0  : https://files.pythonhosted.org/packages/41/e1/d104c83026f8d35dfd2c261df7d64738341067526406b40190bc063e829a/flask-3.0.3.tar.gz
...
%prep
%setup -q -n flask-3.0.3
cd %{_builddir}/flask-3.0.3
pushd ..
cp -a flask-3.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712587382
