...
Source0  : https://files.pythonhosted.org/packages/e8/5c/ff9047989bd995b1098d14b03013f160225db2282925b517bb4a967752ee/Flask-2.2.3.tar.gz
...
%prep
%setup -q -n Flask-2.2.3
cd %{_builddir}/Flask-2.2.3
pushd ..
cp -a Flask-2.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679412014
