...
Source0  : https://files.pythonhosted.org/packages/3f/e0/a89e8120faea1edbfca1a9b171cff7f2bf62ec860bbafcb2c2387c0317be/flask-3.0.2.tar.gz
...
%prep
%setup -q -n flask-3.0.2
cd %{_builddir}/flask-3.0.2
pushd ..
cp -a flask-3.0.2 buildavx2
popd
pushd ..
cp -a flask-3.0.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707147936
